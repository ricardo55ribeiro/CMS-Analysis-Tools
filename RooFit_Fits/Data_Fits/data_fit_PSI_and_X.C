...
root_file_name = "XYZ.root"
mc_psi2s_root_file_name = "MC_PSI_XYZ.root"
mc_x3872_root_file_name = "MC_X_XYZ.root"
...
void total_data_fit_PSI_and_X3872(){
    ...
    // MC for PSI 2S
    TFile *file_mc_psi2s = TFile::Open(mc_psi2s_root_file_name);
    ...
    // MC for X3872
    TFile *file_mc_x3872 = TFile::Open(mc_x3872_root_file_name);
